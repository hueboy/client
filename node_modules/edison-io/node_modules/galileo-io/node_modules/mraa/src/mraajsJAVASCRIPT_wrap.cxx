...
static SwigV8ReturnValue _wrap_mraa_INTEL_GT_TUCHUCK(v8::Local<v8::String> property, const SwigV8PropertyCallbackInfo &info) {
  SWIGV8_HANDLESCOPE();
  
  v8::Handle<v8::Value> jsresult;
  
  jsresult = SWIG_From_int((int)(mraa::INTEL_GT_TUCHUCK));
...
SWIGV8_AddStaticVariable(exports_obj, "INTEL_GT_TUCHUCK", _wrap_mraa_INTEL_GT_TUCHUCK, JS_veto_set_variable);
